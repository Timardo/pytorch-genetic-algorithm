...
#
#  Known issues:
#  - creating of initial population of solutions is slower than expected (probably too much repeated random guesses that are unusable)
#  - mutation and crossover operator produce non-admissible solutions
#  - operation for evaluating the level of inadmissibility is extremely memory intensive and unusable on larger problems or populations
#
############################################################
